...
public class UserService {
    ...
    public UserResponse inviteUser(InviteUserRequest request) {
        validateRoleSpecificFields(request.getRole(), request.getClassName(), request.getCommitteePosition());
        ...
        if (existingUser != null) {
            ...
            if (existingUser.getStatus() == UserStatus.INVITED) {
                ...
                // Tell admin user already invited
                throw new BadRequestException(
                        "User already invited. Use resend invitation option."
                );
            }
